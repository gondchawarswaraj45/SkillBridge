...
public class ContractsAndEscrowView {
    ...
    private HBox createNavbar() {
        ...
        lblCurr.setTextFill(Color.web("#FFFFFF"));
        lblCurr.setFont(Font.font("Segoe UI", FontWeight.BOLD, 12));
        ...
        nav.getChildren().addAll(logo, navLinks, sp, lblCurr, currSelector, btnTheme, btnBackHome);
        return nav;
    }
